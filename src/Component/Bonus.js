        ...
        <div className="accordion-item">
          ...
          <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              The main concept of React is component. A React component can be composed of React components and ReactElement. Following the React way, you divide your app into several components according to function and responsibility.It is maintained by Facebook.
